import { TrainSchedule } from './fetcher';

/**
 * Normalizes a train schedule's times from string to unix timestamps for math.
 */
interface SegTime {
  stationCode: string;
  arr: number; // ms
 ...
 */
export function resolveTrainConflicts(schedules: TrainSchedule[]): TrainSchedule[] {
